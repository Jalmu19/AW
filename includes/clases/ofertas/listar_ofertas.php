...
use BistroFDI\clases\ofertas\TablaOfertas;
...
$accion = true;
$tabla = new TablaOfertas($columnas, $result, $accion);
$contenidoPrincipal .= $tabla->genera();

$contenidoPrincipal .= <<<EOS
    <div class="boton-añadir">
        <form action="crear_actualizar_oferta.php" method="get">
        <button type="submit">
           Añadir Oferta
        </button>
    </form>
